...
enum ENUM_MSG_TYPE {
    ...
    ENUM_MSG_TYPE_UPLOAD_INIT_REQUEST,  // 上传初始化请求
    ENUM_MSG_TYPE_UPLOAD_INIT_RESPOND,  // 上传初始化响应

    ENUM_MSG_TYPE_UPLOAD_CHUNK_REQUEST,  // 上传分片请求
    ENUM_MSG_TYPE_UPLOAD_CHUNK_RESPOND,  // 上传分片响应
